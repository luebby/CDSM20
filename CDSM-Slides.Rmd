...
Based on linear regression results with either excluding $x_1$, $\hat{\beta}^{(1)}_2=-1.505$, or including $\hat{\beta}^{(2)}_2=0.909$ - see survey: 
...
As a friend once said (in a different context): 
