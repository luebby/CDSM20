...
$$X_1 = U_{X_1}, \quad U_{X_1} \sim \mathcal{N}(0,\,10),$$
$$X_2 = -2X_1+U_{X_2}, \quad U_{X_2} \sim \mathcal{N}(0,\,1),$$
$$Y = 5X_1+X_2+U_Y, \quad U_{Y} \sim  \mathcal{N}(0,\,5).$$

Based on OLS table with either including $x_1$ or not: 

.center[*What do you think is the result on $y$ if you increase $x_2$ (by means of an intervention)?*]
...
- `r icon::ai("open-access")`-material for this tal: [https://github.com/luebby/CAUSE-Webinar](https://github.com/luebby/CAUSE-Webinar)
